...
#     listings_df = listings_df[listings_df["✔️ Vote Reset"] == "Yes"]
    ...
    #listings_df["🛒 Discount maxlock %"] = (( listings_df["💰 Sale Price in USD"] / CHR_price ) / listings_df["🔒 Locked CHR"] -1 )* 100
    listings_df["$/veCHR"] = listings_df["💰 Sale Price in USD"] / listings_df["🧾 veCHR Balance"]
    listings_df["$/CHR locked"] = listings_df["💰 Sale Price in USD"] / listings_df["🔒 Locked CHR"]
    listings_df["induced discount (locked CHR / CHR) %"] = (listings_df["$/CHR locked"] / CHR_price -1)*100
